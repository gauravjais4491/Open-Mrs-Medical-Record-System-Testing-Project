...
module.exports = class Login {
    static login = async () => {
            ...
            await expect(await SecurePageForHomePage.flashAlert).toBeExisting()
            await expect(await SecurePageForHomePage.flashAlert).toHaveTextContaining('Logged in as Gaurav Jaiswal (Gaurav) at Registration Desk.')
